...
-- The user data set was corrupted, so I could not view the data set. The join and condition were created based on assumptions from the information sheet.
